package com.chatgptproject.security.jwt;

import com.chatgptproject.security.SecurityConstants;
...
public class JWTUtils {
    ...
    public ResponseCookie generateJwtCookie(UserDetails userPrincipal) {
        ...
        ResponseCookie cookie = ResponseCookie
                .from(jwtCookie, jwt)
                .path("/api")
                .maxAge(SecurityConstants.JWT_EXPIRATION)
                .httpOnly(true)
                .build();
        return cookie;
    }
    ...
    public ResponseCookie getCleanJwtCookie() {
        ResponseCookie cookie = ResponseCookie
                .from(jwtCookie, "")//TODO:check the value(was null)
                .path("/api")
                .maxAge(0)
                .httpOnly(true)
                .build();
